...
| C | C5 — Drive Sancti/02-23o (bissextile) cluster to 0 | 🟡 spot-fired in 2000 (bissextile year). Rust picks Sancti/02-23o (Vigil-of-Matthias) but Perl picks Feria-IV-Septuagesima. The Vigil-of-Matthias slides under bissextile rules — needs `date::sday_pair` correction. Other bissextile years to check: 2004, 2012, 2016, 2024 | — | — |
